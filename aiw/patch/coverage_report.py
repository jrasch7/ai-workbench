"""Coverage report parsing and patch analysis - aiw primary (surgical migration).

Full logic migrated here from aiw_workspace/coverage_report.py .
aiw_workspace/coverage_report.py is now thin delegate.
Prefer importing from aiw.patch.coverage_report or aiw.patch .

Used by patch_gate, changed lines etc for analyze_patch_coverage.
"""

import xml.etree.ElementTree as ET
from pathlib import Path
# aiw-first after profiles migration
try:
