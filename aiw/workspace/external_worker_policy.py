"""External worker policy - aiw primary (surgical migration).

Full logic migrated here. aiw_workspace/external_worker_policy.py is now thin delegate.
Prefer importing from aiw.workspace.external_worker_policy or via aiw .
